...
var app = (function () {
    ...
    /* src/components/NewItem.svelte generated by Svelte v3.44.2 */

    const file$3 = "src/components/NewItem.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input1, /*contents*/ ctx[1]);
    			append_dev(form, t5);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*contents*/ 2 && input1.value !== /*contents*/ ctx[1]) {
    				set_input_value(input1, /*contents*/ ctx[1]);
    			}
    		},
    		i: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('addNewItem' in $$props) $$invalidate(3, addNewItem = $$props.addNewItem);
    	};
    ...
    class NewItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { addNewItem: 3 });
    		...
    		if (/*addNewItem*/ ctx[3] === undefined && !('addNewItem' in props)) {
    			console.warn("<NewItem> was created without expected prop 'addNewItem'");
    		}
    	}
    ...
    /* src/components/UI/Card.svelte generated by Svelte v3.44.2 */

    const file$2 = "src/components/UI/Card.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-10dm889");
    ...
    /* src/components/ItemList.svelte generated by Svelte v3.44.2 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-1uml6gv");
    			add_location(ul, file$1, 8, 2, 137);
    		},
    		m: function mount(target, anchor) {
    ...
    // (10:4) {#each list as item (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	let t1;
    	let p;
    	let t2_value = /*item*/ ctx[2].contents + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			attr_dev(h3, "class", "svelte-1uml6gv");
    			add_location(h3, file$1, 11, 6, 192);
    			add_location(p, file$1, 12, 6, 220);
    			attr_dev(li, "class", "svelte-1uml6gv");
    			add_location(li, file$1, 10, 4, 181);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*list*/ 1 && t0_value !== (t0_value = /*item*/ ctx[2].title + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*list*/ 1 && t2_value !== (t2_value = /*item*/ ctx[2].contents + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:4) {#each list as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isEmpty*/ ctx[1]) return create_if_block;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ list, isEmpty });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*list*/ 1) {
    			$$invalidate(1, isEmpty = !list.length);
    		}
    	};
    ...
    class ItemList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { list: 0 });
    		...
    		if (/*list*/ ctx[0] === undefined && !('list' in props)) {
    			console.warn("<ItemList> was created without expected prop 'list'");
    		}
    	}
    ...
    function create_default_slot_1(ctx) {
    	...
    	newitem = new NewItem({
    			props: { addNewItem: /*addNewItem*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(newitem, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    		...
    		d: function destroy(detaching) {
    			destroy_component(newitem, detaching);
    		}
    	};
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*list*/ 1) itemlist_changes.list = /*list*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addNewItem = (title, contents) => {
    		$$invalidate(0, list = [
    			...list,
    			{
